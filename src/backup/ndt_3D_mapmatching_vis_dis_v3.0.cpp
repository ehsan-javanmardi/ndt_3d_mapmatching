/*
 ...
 2017.07.05
 ndt_3D_mapmatching_vis_dis_v3.0

 TETS :
    code is not tested yet

 CHANGE LOG :
    Based on based on ndt_3D_mapmatching_vis_dis_v2.0
...
{
    std::cout << "ndt_3D_mapmatching_vis_dis_v3_0\n" ;
    ros::init(argc, argv, "ndt_3D_mapmatching_vis_dis_v3_0");
