...
{
    std::cout << "ndt_3d_mapmatching_groundtruth_v1_0\n" ;
    ros::init(argc, argv, "ndt_3d_mapmatching_groundtruth_v1_0");
    ...
    save_path = save_path + str_time + "ndt_mapmatching_groundtruth" +  "/";
    ...
    // add setup file spec in save_path directory
