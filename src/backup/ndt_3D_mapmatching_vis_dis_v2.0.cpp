/*
 ...
 2017.07.04
 ndt_3D_mapmatching_vis_dis_v2.0

 TETS :
    code is not tested yet

 CHANGE LOG :
    Based on based on ndt_3D_mapmatching_vis_dis_v1.1
    The code is updated becasue the ndt_vis_distortion is changed
...
*/
    ...
    // This function also update the delta_t

    downSampleWithDeltaT(scan, filtered_scan, delta_t, voxel_leaf_size, voxel_leaf_size, voxel_leaf_size);
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filter_scan_ptr(new pcl::PointCloud<pcl::PointXYZI>(filtered_scan));

    ndt.setInputSource(filter_scan_ptr);

    ndt.setPreviousTF(tf_previous);

    ndt.setInputPointDeltaT(delta_t);
    ...
    pcl::PointCloud<pcl::PointXYZI> transformed_dis_scan;
    ...
    fprintf (pFileLog, "%i,%f,%f,%f,%f,%f,%f,%i,%f,%f,%i,%f,%f,%f,%f,%i\n",\
             input->header.seq, \
...
{
    std::cout << "ndt_3D_mapmatching_vis_dis_v2_0\n" ;
    ros::init(argc, argv, "ndt_3D_mapmatching_vis_dis_v2_0");
